...
def create_startup_task():
    """Create a task to add the application to startup."""
...
def main():
    ...
    def on_login_click(event=None):
        ...
        if USERNAME:
            ...
            show_task_management_screen(USERNAME, USER_ID)  # Refresh the UI
    ...
    def show_task_management_screen(username, user_id):
        ...
        # Update button states based on STAFF_IN_TIME
        if STAFF_IN_TIME is None:
        ...
        staff_out_button_reference = staff_out_button  # Ensure this is assigned
    ...
    def show_login_screen():
        ...
        hide_taskbar()
        block_input()  # Block keys when showing the login screen
